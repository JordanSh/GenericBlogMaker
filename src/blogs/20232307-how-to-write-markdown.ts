...
// 5. add file to index.ts barrel

import { Blog } from ".";

export const howToWriteMarkdown: Blog = {
  id: "how-to-write-markdown",
  title: "How to write markdown with ReactMarkdown",
  description: "A short guide on markdown writing",
  date: "July 23th, 2023",
